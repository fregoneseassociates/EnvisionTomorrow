    ...
    Private Sub frmLocalJobsHousingBalance_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If intFeatCount <= 0 Then
                MessageBox.Show("No file geodatabase polygon feature layers could be found in the current view document.  Please added polygon layers to view before utilizing this tool.", "No Polygon Layers Found", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly, False)
                GoTo CleanUp
            End If
...
CleanUp:
    ...
    Private Sub btnRun_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRun.Click
        ...
        If m_TractLayer Is Nothing Then
            MessageBox.Show("Please select a Tracking layer.", "No Tracking Layer Selected", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly, False)
            GoTo CleanUp
        Else
        ...
        If Me.tbxBufferDistance.Text.Length > 0 Then
            If Not IsNumeric(Me.tbxBufferDistance.Text) Then
                MessageBox.Show("Please provide a valid buffer distance.", "Invalid Buffer Distance", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly, False)
                blnFailed = True
                GoTo CleanUp
            End If
        Else
        ...
        If Me.cmbEmployedRes.Text.Length <= 0 Then
            MessageBox.Show("Please select a 'Population' field.", "Field Required", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly, False)
            blnFailed = True
            GoTo CleanUp
        Else
        ...
        If Me.cmbEmployees.Text.Length <= 0 Then
            MessageBox.Show("Please select a 'Workers' field.", "Field Required", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly, False)
            blnFailed = True
            GoTo CleanUp
        Else
        ...
        If Me.cmbAvgResIncome.Text.Length <= 0 Then
            MessageBox.Show("Please select a 'Avg. Income of Residents' field.", "Field Required", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly, False)
            blnFailed = True
            GoTo CleanUp
        Else
        ...
        If Me.cmbAvgWorkersIncome.Text.Length <= 0 Then
            MessageBox.Show("Please select a 'Avg. Income of Workers' field.", "Field Required", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly, False)
            blnFailed = True
            GoTo CleanUp
        Else
        ...
        Catch ex As Exception
            MessageBox.Show("Error:" & vbNewLine & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly, False)
            GoTo CleanUp
        End Try
        ...
        Catch ex As Exception
            MessageBox.Show("Error: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly, False)
            GoTo CleanUp
        End Try
        ...
        Else
            IncomeBalanceLegend()
        End If
        MessageBox.Show("Jobs-Housing Balance processing has completed", "Processing Complete", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly, False)
        GoTo CleanUp
...
CleanUp:
    ...
    Public Sub JobWorkerLegend()
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "JobWorkerLegend Sub Error", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, MessageBoxOptions.DefaultDesktopOnly, False)
            GoTo CleanUp
        End Try
