...
CleanUp:
    ...
    Private Sub cmbLayers_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbLayers.SelectedIndexChanged
        ...
        End If
        If pFeatureClass.FindField("TOT_LU_MIX_QRTMi") = -1 Then
            AddEnvisionField(pTable, "TOT_LU_MIX_QRTMi", "DOUBLE", 16, 6)
        End If
        If pFeatureClass.FindField("EX_PRE_LU_MIX_QRTMi") = -1 Then
            AddEnvisionField(pTable, "EX_PRE_LU_MIX_QRTMi", "DOUBLE", 16, 6)
        End If
        ...
        Do While Not pFeat Is Nothing
            ...
            Try
                ...
                If pBuffFeatSelection.SelectionSet.Count > 0 Then
                    ...
                    CalcLandUseMix(dblTotalAcres, "TOT_LU_MIX_QRTMi", pFeat)
                    CalcPRELandUseMix(m_dblExTotalAcres, "EX_PRE_LU_MIX_QRTMi", pFeat)
                End If
