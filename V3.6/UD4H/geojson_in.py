"""
Attribution: this code module was taken from the github repository located here:
...
def geojson_to_feature(in_geojson, out_feature_class):
    ...
    #arcpy.AddMessage("json_struct: " + str(json_struct))
    out_schema = determine_schema(json_struct)
    #arcpy.AddMessage("out_schema: " + str(out_schema))
