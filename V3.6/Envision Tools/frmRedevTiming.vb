...
CleanUp:
  ...
  Private Sub RunDepreciation()
    ...
    If m_ParcelLayer Is Nothing Then
      MessageBox.Show(Me, "Please select a parcel layer.", "No Parcel Layer Selected", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
      GoTo CleanUp
    Else
    ...
    If Me.cmbYearBuilt.Text.Length <= 0 Then
      MessageBox.Show(Me, "Please select a Year Built field.", "Field Required", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
      GoTo CleanUp
    Else
      intYearBuiltFld = pFeatClass.FindField(Me.cmbYearBuilt.Text)
    End If
    If Me.cmbImproveValue.Text.Length <= 0 Then
      MessageBox.Show(Me, "Please select a Improvement or Building Value field.", "Field Required", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
      GoTo CleanUp
    Else
      intImprovementValueFld = pFeatClass.FindField(Me.cmbImproveValue.Text)
    End If
    If Me.cmbLandValue.Text.Length <= 0 Then
      MessageBox.Show(Me, "Please select a Land Value field.", "Field Required", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
      GoTo CleanUp
    Else
    ...
    If Me.tbxCurrentYear.Text.Length = 4 Then
      ...
      Else
        MessageBox.Show(Me, "Please enter a valid Current Year value.", "Invalid User Input", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
        GoTo CleanUp
      End If
    Else
      MessageBox.Show(Me, "Please enter a valid Current Year value.", "Invalid User Input", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
    ...
    Else
      MessageBox.Show(Me, "Please enter a valid Building Lifespan value.", "Invalid User Input", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
      GoTo CleanUp
    End If
    ...
    Else
      MessageBox.Show(Me, "Please enter a valid Annual Land Appreciation value.", "Invalid User Input", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
      GoTo CleanUp
    End If
...
CleanUp:
    If intFailureCount >= 1 Then
      MessageBox.Show(Me, CStr(intFailureCount) & " features failed to have a value writen to a file.  Last error message was: " & vbNewLine & strFailureMsg, "Process Complete: Error(s) Found", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1)
    End If
  ...
  Private Sub RunBottomQuartile()
    ...
    If Me.cmbSqFt.Text.Length <= 0 Then
      MessageBox.Show(Me, "Please select a Square Footage Value field.", "Field Required", MessageBoxButtons.OK, MessageBoxIcon.Stop, MessageBoxDefaultButton.Button1)
      GoTo CleanUp
    Else
